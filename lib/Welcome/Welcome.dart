...
class NotificationController {
  ...
  static Future<void> onActionReceivedMethod(ReceivedAction receivedAction) async {
    ...
    print("incident obj notif $incident_obj");
    if (receivedAction.actionType == ActionType.SilentAction || receivedAction.actionType == ActionType.SilentBackgroundAction) {
      ...
      if (Welcome.navigatorKey.currentState != null) {
        ...
        final http.Response result = await http.post(Uri.parse(
            '${ApiConstants.baseUrl}/incident/${request}/accept/${await SharedPreferences.getInstance().then((prefs) => prefs.getString('id') ?? "0")}'));
        Map<String, dynamic> response = json.decode(result.body);
        print(response);
        if (response['status'] == 'accepted') {
          Welcome.navigatorKey.currentState?.push(MaterialPageRoute(builder: (context) => RedirectDestination(incident_obj: incident_obj)));
        }
  ...
  static Future<void> createNewNotification() async {
    ...
    await AwesomeNotifications().createNotification(
        ...
        actionButtons: [
          ...
          NotificationActionButton(key: 'DISMISS', label: 'DECLINE', actionType: ActionType.DismissAction, isDangerousOption: true)
        ]);
  }
...
class _Welcome extends State<Welcome> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        theme: ThemeData(
          ...
          navigationBarTheme: NavigationBarThemeData(
              ...
              labelTextStyle: MaterialStateProperty.all(
                GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.black54),
              )),
        ...
        locale: _locale,
        home: widget.who == 'logged_in' ? (is_lifesaver ? const Lifesaver() : const Citizen()) : WelcomeContent(setLocale: setLocale)
        // home: Scaffold()
        );
  }
}
                    ...
                    Row(
                      ...
                      children: [
                        PopupMenuButton<LocaleMenu>(
                          ...
                          itemBuilder: (BuildContext context) => <PopupMenuEntry<LocaleMenu>>[
                        ...
                        SizedBox(
                            height: 48,
                            child: TextButton(
                                onPressed: () => (Navigator.of(context).push(MaterialPageRoute(builder: (context) => const Register()))),
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 1.0, color: Colors.black38),
                              )),
                          SizedBox(
                            height: 48,
                            width: double.infinity,
