...
from .models import Citizen, Lifesaver, Incident, Request, PostInfo
from rest_framework import serializers
...
class LifesaverSerializer(serializers.ModelSerializer):
    class Meta:
        model = Lifesaver
        fields = ('id', 'lifesaver', 'first_name', 'last_name', 'date_of_birth', 'address', 'latitude','longitude', 'longitude', 'cnic', 'training_id', 'contact_no', "calls_received", 'badge')

class CitizenSerializer(serializers.ModelSerializer):
    class Meta:
        model = Citizen
        fields = ('id', 'citizen', 'first_name', 'last_name', 'date_of_birth', 'address', 'contact_no', 'calls_made')
